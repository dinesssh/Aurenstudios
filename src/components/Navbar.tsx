...
export function Navbar() {
  ...
  return (
    <>
      <motion.div
        className="fixed top-0 left-0 right-0 h-[2px] bg-[#ff4d00] transform origin-left z-[60]"
        style={{ scaleX }}
      />
      <nav
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex items-center justify-between w-full h-16">
          ...
          <div className="hidden md:flex items-center gap-9 text-[14px] text-[#888888] font-medium">
            ...
            <a
              href="#contact"
              className="bg-white text-black font-semibold px-5 py-2 rounded-full text-sm hover:bg-[#ff4d00] hover:text-white transition-colors duration-200"
            >
              Book a Call
            </a>
          </div>
